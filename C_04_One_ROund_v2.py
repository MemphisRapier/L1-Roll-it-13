...
# if the computer has fewer points, switch the computer 'player 1'
else:
...
while player_1_points < 13 and player_2_points < 13:
    ...
    player_1_points = random.randint(1, 6)
    player_1_points += player_1_points

    print(f"{second}: Rolled a {player_1_points} - has {player_2_points} points")
